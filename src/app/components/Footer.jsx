...
const Footer = () => {
  return (
    <div className=" mt-40  ">
      <div
        className="  flex  flex-wrap flex-1  lg:flex-nowrap  lg:justify-center justify-evenly
       lg:mx-0 mx-12 lg:gap-[8%] gap-5"
      >
        ...
        <div className=" flex flex-col lg:gap-4 gap-2 lg:mt-0 mt-10 lg:mx-0 mx-6">
          ...
          <form className="a bg-white py-2 px-4 lg:w-[340px] w-[300px]  flex gap-3">
            ...
            />
            <button className=" w-[160px] lg:h-[61px] h-[51px] rounded-md bg-black text-white hover:bg-red-600 ease-linear transition-all">
              Subscribe
            </button>
          </form>
        </div>
